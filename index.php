...
<!-- login -->
    <div class="login">
        ...
        <div class="mt-4"></div>
            ...
            <div style="background-color: rgb(100, 100, 100); padding: 5px; padding-bottom: -10px; width: 70%; margin-left: auto; margin-right: auto; border-radius: 15px;" class="username">
