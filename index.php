              ...
              <div class="modal-dialog modal-fullscreen">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="float-start d-flex align-items-center wrap-text justify-content-center" style="background-color: gray; border-radius: 100px; width: 45px; height: 45px;">
                        <?php 
