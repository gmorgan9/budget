...
<!-- Container -->
    <div class="container-fluid">
        ...
        <section class="" data-page="transactions">
            ...
            <div class="row d-flex justify-content-center background" style="z-index: 6; left: 0 !important;height: 15px; width: 100%; margin-top: 125px; background-color: rgb(245, 245, 245);"></div>
