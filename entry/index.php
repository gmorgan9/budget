...
<!-- Container -->
    <div class="container-fluid">
            ...
            <!-- header -->
                <div class="header" style="background-color: #3e4881; width: 108% !important; height: 60px; margin-left: -5%;">
        ...
        <section class="active" data-page="&#8211; expenses">
            ...
            <form action="" class="" method="POST">
                ...
                <button type="submit" name="exp" class="mt-3 btn" style="background-color: rgb(215, 215, 215);">Submit</button>
            </form>
        </section>
